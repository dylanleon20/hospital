...
<td><a onclick="confirm('are you sure you want to delete {{ $Doctor->name }} ?')?document.getElementById('delete-{{ $Doctor->id }}').submit():''" href="#"><i class="fas fa-trash"></i>delete</a>
<form action="{{ route('doctor.destroy',$Doctor->id) }}" method="post" id="delete-{{ $Doctor->id }}" >
@csrf
    ...
    <div class="testbox">
        ...
        <div class="col-lg-12">
            <div class="form-group input-group-sm">
                ...
                <input type="number" class="form-control" name="id_number" id="id">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group input-group-sm">
                                ...
                                <input type="email" class="form-control" name="email" id="email">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group input-group-sm">
                                                <label for="region"> patient</label>
                                                <input type="text" class="form-control" name="patient" id="patientt">
